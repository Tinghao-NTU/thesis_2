...
def permute_device(action, clusteded_dic, cluster_index):
    ...
    device_list = np.append(selected_device,index_list).tolist()
...
def local_update(args,dataset_train,dataset_test,dict_users,idxs_users,epoch,net_glob,acc_list = None,w_list = None, name = None, preset = None):
    w_locals_temp = []
    loss_locals = []
...
#         acc_test, loss_test = test_img(net_glob, dataset_test, args)     
    ...
    reward_n = [pow(1.2, acc_list[-1]-55)-1] * 10 

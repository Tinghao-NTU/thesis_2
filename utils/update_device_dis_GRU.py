...
def local_update(args,dataset_train,dataset_test,dict_users,idxs_users,epoch,net_glob, acc_list = None,cluster_acc = None, w_list = None, name = None,preset  = None,count_list = None):
    w_locals_temp = []
    loss_locals = []
    all_clients = 100
    n = all_clients

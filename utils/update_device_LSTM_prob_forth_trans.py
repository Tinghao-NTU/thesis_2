...
def local_update(args,dataset_train,dataset_test,dict_users,idxs_users,epoch,net_glob,acc_list = None,w_list = None, name = None,preset  = None, coeff = None,gtk = None, prob = 0, seed = None):
    w_locals_temp = []
    loss_locals = []
    all_clients = 100
    n = all_clients

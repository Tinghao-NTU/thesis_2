...
def local_update(args,dataset_train,dataset_test,dict_users,idxs_users,epoch,net_glob,next_state_list = None,acc_list = None, name = None):
    w_locals_temp = []
    loss_locals = []
...
#         acc_test, loss_test = test_img(net_glob, dataset_test, args)     
    ...
    if epoch == 0 :
        ...
        return next_state,next_state_list,net_glob, acc_list,clusteded_dic
    else:
        return next_state_list,net_glob, acc_list, reward_n,done_n

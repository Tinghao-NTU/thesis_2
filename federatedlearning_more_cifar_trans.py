...
from utils.update_device_LSTM_Compare_trans import local_update,get_state,permute_device
...
num_devices = 10
name1 = 'TrainingRecords_more_trans_'+str(num_devices)+bias+'_'
name2 = 'Device_list_more_trans_'+bias
name3 = 'Rewards_more_trans_'+bias
...
#             print(np.mean(delta))
    ...
    dict_users,idxs_users,epoch,net_glob,rou= rou,beta=beta,delta = delta,acc_list = acc_list, w_list = w_list, name =name1+'cifar_'+str(roll_num)+'.txt',preset = preset_accuracy, seed = seed)            

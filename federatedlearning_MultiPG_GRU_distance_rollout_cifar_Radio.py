...
for ep_iter in range(1):
    ...
    torch.save(net_glob_init.state_dict(),'test_cifar_trained_'+bias+'.pkl')
    ...
    for roll_num in range(10):
        ...
        while not done: 
            ...
            file_handle=open(name2+'cifar'+'.txt',mode='a')
        ...
        file_handle=open('Devices_num_cifar'+bias+'.txt',mode='a')

...
name1 = 'TrainingRecords_prob_trans_'+str(each_num*10)+bias+'_test'
name2 = 'Device_list_prob_trans_'+bias+'_test'
name3 = 'Rewards_prob_trans_'+'_test'
    ...
    for roll_num in range(6,30):
        ...
        while not done: 
            ...
            next_state_matrix,net_glob,acc_list,w_list, reward_n,done_n,gtk= local_update(args,dataset_train,dataset_test,
                        dict_users,idxs_users,epoch,net_glob,acc_list = acc_list, w_list = w_list, name =name1+'prob_cifar_'+str(roll_num)+'.txt',preset = preset_accuracy, gtk = gtk, prob = 1, seed  = 1)            

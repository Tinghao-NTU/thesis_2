...
name1 = 'TrainingRecords_LSTM_changethird_test_'+str(num_devices)+bias+'_'
name2 = 'Device_list_ppo_LSTM_changethird_test_'+bias
name3 = 'Rewards_ppo_LSTM_changethird_test_'+bias

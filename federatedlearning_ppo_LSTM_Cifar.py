...
name1 = 'TrainingRecords_LSTM_'+str(num_devices)+bias+'_'
name2 = 'Device_list_ppo_LSTM_'+bias
name3 = 'Rewards_ppo_LSTM_'+bias
...
#         print(np.sort(idxs_users))
    ...
    if ep_iter > 20:
        if np.mean(all_rewards[-20:]) > max_reward:
            torch.save(model.state_dict(), 'ppo_LSTM_cifar_'+bias+'.pkl')
